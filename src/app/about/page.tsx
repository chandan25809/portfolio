...
export default function AboutPage() {
  return (
    <div className="text-left space-y-6">
      ...
      <div className="card-journal p-6 space-y-4">
      ...
      <div className="card-journal p-6">
        ...
        <ul className="grid sm:grid-cols-2 gap-2 font-mono text-xs sm:text-sm list-disc list-inside marker:text-accent-gold">
